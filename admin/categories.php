            ...
            <div class="row">
                <div class="col-lg-6">
                    <form action="categories.php" method="post">
                        ...
                        <div class="form-group mb-4">
                            <input type="text" class="form-control" name="catname" value="<?= $editdata['catname'] ?>"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <form action="categories.php" method="post">
                                    ...
                                    <div class="form-group mb-4">
                                        <input type="text" class="form-control" name="catname" id="catname" value=""
                                            placeholder="enter category">
                                    </div>
                                    <div class="form-group ">
                                ...
                                if (mysqli_num_rows($res) > 0) {
                                    while ($data = mysqli_fetch_array($res)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $data['catname'] ?></td>
                                            <td>
                                                <a href="categories.php?editid=<?= $data['catid'] ?>" class="btn btn-primary">
                                                    Edit</a>
                                                <a href="categories.php?deleteid=<?= $data['catid'] ?>" class="btn btn-danger">
                                                    Delete</a>
                                            </td>
                                        </tr>
